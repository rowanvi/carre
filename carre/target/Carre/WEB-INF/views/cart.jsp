                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <!--  <                       <%
                        ...
                        <c:if test="${empty listProductorderNieuw}"><br><br><br>
                            <h4>Winkelwagen is leeg, <a href="${pageContext.request.contextPath}/webshop">klik hier om naar de shop te gaan.</a></h4>
                            <br><br><br>
                        </c:if>
                                        ...
                                        <tbody>
                                            ...
                                            <c:forEach items="${listProductorderNieuw}" var="productorder">
                                                <c:set value="${productorder.productid}" var="id"></c:set>
                                                    ...
                                                    <td>
                                                        <a href="${pageContext.request.contextPath}/cart/update/${productorder.id}">Update aantal</a> 
                                                    </td>

                                                    <td class="product-remove">

                                                        <a href="${pageContext.request.contextPath}/cart/delete/${productorder.id}"><i style="color:red;" class="fa fa-times"></i></a>
                                                    </td>
                                                </tr>
                                ...
                                <div class="row">
                                    <div class="col-md-8 col-sm-7 col-xs-12">
                                        <div class="buttons-cart">
                                            ...
                                            <a href="${pageContext.request.contextPath}/webshop">Naar de winkel</a>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-5 col-xs-12">
                                        <div class="cart_totals">
                                            ...
                                            <div class="wc-proceed-to-checkout">
                                                <a href="${pageContext.request.contextPath}/orderinfo">Afrekenen</a>
                                            </div>
