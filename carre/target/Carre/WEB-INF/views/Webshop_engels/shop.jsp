                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <aside class="widget widget-categories">
							...
							<ul class="sidebar-menu">
								...
								<li><a href="${pageContext.request.contextPath}/Webshop_engels/webshop/${categorie.id}">${categorie.naam_engels}</a> <span class="count"></span></li>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-action">
                                                    <div class="pro-button-top">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/Webshop_engels/webshop/addtocart/${product.id}">Add to cart</a>
                                                    </div>
