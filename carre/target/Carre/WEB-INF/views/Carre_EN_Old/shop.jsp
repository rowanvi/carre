                ...
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    ...
                    <aside class="widget widget-categories">
							...
							<ul class="sidebar-menu">
								...
								<li><a href="${pageContext.request.contextPath}/Webshop_engels/webshop/${categorie.id}">${categorie.naam}</a> <span class="count"></span></li>
                                        ...
                                        <div class="single-product" >
                                            <div class="product-img">
                                                ...
                                                <div class="product-action">
                                                    <div class="pro-button-top">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/Webshop_engels/webshop/addtocart/${product.id}">Toevoegen aan winkelwagen</a>
                                                    </div>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="pro-price">
                                                    ...
                                                    <span class="normal"><fmt:formatNumber currencySymbol="$" type="currency" value="${product.prijs}"/></span> 
                                                </div>
