              ...
              <div class="leftpanel">
                ...
                <div class="leftmenu">        
                    <ul class="nav nav-tabs nav-stacked">
                        ...
                        <li class="dropdown active"><a href="#"><span class="iconfa-th-list"></span> Orders</a>
                            <ul>
            ...
            <div class="rightpanel">
                ...
                <div class="maincontent">
                    <div class="maincontentinner">
                        ...
                        <h4 class="widgettitle">Orders per persoon van voorstelling ${voorstelling.naam} op ${voorstelling.datum}</h4><br>
                        <c:if test="${!empty listWinkelwagen}">
                            <c:forEach items="${listWinkelwagen}" var="winkelwagen">
                                <c:set value="${winkelwagen.sessieid}" var="sessieid"></c:set>
                                <div class="widgettitle" style="background-color:#960303">${winkelwagen.voornaam} ${winkelwagen.achternaam} | ${winkelwagen.email}
                                    <c:if test="${winkelwagen.status == 1}">
                                    <div style="float:right">
                                        Status: Betaald | <a href="<c:url value="/admin/orderlist/shows/${voorstelling.id}/${winkelwagen.winkelwagenid}/1"/>"><button>Bestelling is opgehaald</button></a>
                                    </div>
                                    </c:if>
                                    <c:if test="${winkelwagen.status == 2}">
                                    <div style="float:right">
                                        Status: Opgehaald |  <a href="<c:url value="/admin/orderlist/shows/${voorstelling.id}/${winkelwagen.winkelwagenid}/2"/>"><button>Bestelling is niet opgehaald</button></a>
                                    </div>
                                    </c:if>
                            ...
                            <table id="dyntable" class="table table-bordered responsive">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="head0">Aantal</th>
                                    </tr>
                                </thead>
                                <c:forEach items="${productorder.listProductorderNieuw(sessieid)}" var="productorder">
                                    <c:set value="${productorder.productid}" var="productid"></c:set>
                                <tbody>
                                    
                                        <tr>
                                            <td>${product.getProductById(productid).productnaam}</td>
                                            <td>${productorder.aantal}</td>      
                                        </tr>
