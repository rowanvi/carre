                    ...
                    <div class="maincontentinner">
                        <div class="widgetbox box-inverse">
                            ...
                            <div class="widgetcontent wc1">
                                <c:url var="addAction" value="/catalogus/add" ></c:url>

                                <form:form action="${addAction}" commandName="catalogus">
                                ...
                                <tbody>
                                    <c:forEach items="${listCatalogus}" var="catalogus">
                                        <tr>
                                            ...
                                            <td class="center"><a href="<c:url value='catalogus/edit/${catalogus.id}' />" >Edit</a></td>
                                        </tr>
                                    </c:forEach>
