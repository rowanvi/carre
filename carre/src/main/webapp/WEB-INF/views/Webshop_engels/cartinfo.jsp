            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-4">
                        <div class="welcome">
                            <span class="phone">Phone</span> <span class="hidden-sm">/</span>
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="contact-form">
                            <h3>
                                <i class="fa fa-envelope-o"></i>Order form</h3>
                            <div class="row">
                                <form:form action="${pageContext.request.contextPath}/Webshop_engels/orderinfo/post" method="POST" commandName="winkelwagen">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                 
                                        <form:input path="voornaam" placeholder="Firstname" />
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                   
                                        <form:input path="achternaam" placeholder="Lastname" />
                                    </div>
                                    ...
                                    <form:select path="voorstellingid">
                                        <form:option value="0" label="Selecteer voorstelling"/>
                                        
                                        <c:forEach items="${listVoorstelling}" var="voorstelling">
                                            <form:option value="${voorstelling.id}" label="${voorstelling.naam}  |  ${voorstelling.datum}"/>
                                    ...
                                    <input type="submit" value="<spring:message text="Checkout"/>" />
                                    </div>
                                </form:form>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-4">
                            <div class="footer-widget">
                                ...
                                <p>Hello welcome to the official pre order store for carré. You can find our contact information to the right.</p>
