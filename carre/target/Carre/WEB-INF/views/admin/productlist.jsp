                            ...
                            <table id="dyntable" class="table table-bordered responsive">
                                ...
                                <tbody>
                                    <c:forEach items="${listProduct}" var="product">
                                        <c:set value="${product.categorieid}" var="cateid"></c:set>
                                        <c:set value="In voorraad" var="status"></c:set>
                                        <c:if test="${product.status == 2}">
                                            <c:set value="Uitverkocht" var="status"></c:set>
                                        </c:if>
                                        ...
                                        <tr>
                                            ...
                                            <td>${categorie.getCategorieById(cateid).naam}</td>

                                            <td class="center"><fmt:formatNumber type="currency" value="${product.prijs}"/></td>

                                            <td class="center">${status}</td>
                                            <td class="center"><a href="<c:url value='/admin/addproduct/edit/${product.id}' />" >Edit</a></td>
                                        </tr>
