                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="contact-form">
                            <h3>
                                <i class="fa fa-envelope-o"></i>Bestel formulier</h3>
                            <div class="row">
                                <form:form action="${pageContext.request.contextPath}/orderinfo/post" method="POST" commandName="winkelwagen">
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                 
                                        <form:input path="voornaam" placeholder="Voornaam" />
                                    </div>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                   
                                        <form:input path="achternaam" placeholder="Achternaam" />
                                    </div>
                                    ...
                                    <input type="submit" value="<spring:message text="Afrekenen"/>" />
                                    </div>
                                </form:form>
                            </div>
                        </div>
