...
<html>
    <head>
        ...
        <title>Carre Pre-order</title>
        <link href="<c:url value="/resources/carre/css/style.css" />" rel="stylesheet">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a href="#"><span>
                            <img src="img/banner/banner-14.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a class="last-banner" href="#"><span>
                            <img src="img/banner/banner-15.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a href="#"><span>
                            <img src="img/banner/banner-16.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
                <!-- single-banner start -->
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-banner">
                        <a class="last-banner" href="#"><span>
                            <img src="img/banner/banner-17.jpg" alt=""></span></a>
                    </div>
                </div>
                <!-- single-banner end -->
            </div>
