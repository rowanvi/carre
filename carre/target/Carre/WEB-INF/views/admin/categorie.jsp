                    ...
                    <div class="maincontentinner">
                        <div class="widgetbox box-inverse">
                            ...
                            <div class="widgetcontent wc1">
                                ...
                                <c:url var="addAction" value="/admin/categorie/add" ></c:url>
                                ...
                                <form:form action="${addAction}" commandName="categorie">
                                    ...
                                    <div class="par control-group">
                                        <label class="control-label">Categorie naam engels</label>
                                        <div class="controls"><form:input path="naam_engels" /></div>
                            ...
                            <table id="dyntable" class="table table-bordered responsive">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="head0">Categorie Engels</th>
                                ...
                                <tbody>
                                    <c:forEach items="${listCategorie}" var="categorie">
                                        <tr>
                                            ...
                                            <td>${categorie.naam_engels}</td>
                                            <td class="center"><a href="${pageContext.request.contextPath}/admin/categorie/edit/${categorie.id}" >Edit</a></td>
                                        </tr>
                                    </c:forEach>
